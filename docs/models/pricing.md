...
| Grounding with Google Search             | Not available                                 | 5,000 search queries per month (free), then (Coming soon) $14 / 1,000 search queries                    |
...
^\*^For Grounding with Google Search, each prompt can generate multiple search queries.  
